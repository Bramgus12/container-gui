        ...
        SheetScaffold(
            ...
            VStack(spacing: 0) {
                ...
                if model.session == nil {
                    InlineBanner(
                        message: "sudo will ask for your administrator password in the terminal below. It is typed into CargoDeck’s own terminal, not the macOS password dialog — cancel and use Add Domain if you would rather macOS collected it.",
                        scope: .bar,
                        severity: .attention
                    )
