...
struct UpdateResultSheet: View {
    ...
    private var message: String {
        switch result {
        case .available(let release):
            "CargoDeck \(release.version.description) is available. You have \(model.installedVersionDescription)."
        case .upToDate:
            "CargoDeck \(model.installedVersionDescription) is the latest release."
